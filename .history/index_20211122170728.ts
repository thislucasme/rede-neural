...
console.log("[1, 1] " + temp + ` ${round(temp[0] * 100, 2)} %`)
temp = standalone([1, 0]);
console.log("[1, 0] " + temp + ` ${round(temp[0] * 100, 2)} %`)
temp = standalone([0, 1])
console.log("[0, 1] " + temp + ` ${round(temp[0] * 100, 2)} %`)
temp = standalone([0, 0])
console.log("[0, 0] " + temp[0] + ` ${round(temp[0] * 100, 2)} %`)
